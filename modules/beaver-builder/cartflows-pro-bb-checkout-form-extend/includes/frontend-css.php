...
<?php if ( 'yes' === $product_options && $show_product_options ) { ?>
	...
	.fl-node-<?php echo $module_id; ?> .cartflows-bb__checkout-form .wcf-product-option-wrap.wcf-yp-skin-classic .wcf-qty-options .wcf-qty-row,
	...
	.fl-node-<?php echo $module_id; ?> .cartflows-bb__checkout-form .wcf-product-option-wrap.wcf-yp-skin-cards-inline .wcf-qty-options .wcf-qty-row{
		background-color: <?php echo FLBuilderColor::hex_or_rgb( $module_settings->product_bg_color ); ?>;
	}
	.fl-node-<?php echo $module_id; ?> .cartflows-bb__checkout-form .wcf-product-option-wrap.wcf-yp-skin-classic .wcf-qty-options .wcf-qty-row,
	.fl-node-<?php echo $module_id; ?> .cartflows-bb__checkout-form .wcf-product-option-wrap.wcf-yp-skin-cards .wcf-qty-options .wcf-qty-row,
	.fl-node-<?php echo $module_id; ?> .cartflows-bb__checkout-form .wcf-product-option-wrap.wcf-yp-skin-cards-inline .wcf-qty-options .wcf-qty-row {
		border-radius: <?php echo ( '' != $module_settings->product_option_border_radius ) ? $module_settings->product_option_border_radius : ''; ?>px;
	}
	...
	.fl-node-<?php echo $module_id; ?> .cartflows-bb__checkout-form .wcf-product-option-wrap .wcf-qty-options .wcf-qty-row.wcf-highlight {
		border-radius: <?php echo ( '' != $module_settings->highlight_product_border_radius ) ? $module_settings->highlight_product_border_radius : ''; ?>px;
	}
