...
if ( ! class_exists( 'Cartflows_Pro_Loader' ) ) {
	...
	final class Cartflows_Pro_Loader {
		...
		public function define_constants() {
			...
			define( 'CARTFLOWS_PRO_VER', '2.2.1' );
			...
			define( 'CARTFLOWS_PRO_REQ_CF_VER', '2.2.0' );
			...
			define( 'CARTFLOWS_ANALYTICS_COOKIE_EXPIRE_TIME', 365 );
		...
		public function load_core_components() {
			...
			if ( 'bricks-builder' === $page_builder ) {
				if ( Cartflows_Compatibility::is_bricks_enabled() ) {
					include_once CARTFLOWS_PRO_DIR . 'modules/bricks/class-cartflows-pro-bricks-elements-loader.php';
				}
			}
			...
			$this->load_funnel_analytics_classes();
		}
		...
		/**
		 * Local the funnel analytics essential classes.
		 *
		 * @return void
		 * @since 2.2.0
		 */
		public function load_funnel_analytics_classes() {
			...
			// Load analytics helper classes first.
			include_once CARTFLOWS_PRO_DIR . 'modules/tracking/analytics-helper/class-cartflows-pro-analytics-calculations.php';
			include_once CARTFLOWS_PRO_DIR . 'modules/tracking/analytics-helper/class-cartflows-pro-analytics-optin.php';
			include_once CARTFLOWS_PRO_DIR . 'modules/tracking/analytics-helper/class-cartflows-pro-analytics-products.php';
			include_once CARTFLOWS_PRO_DIR . 'modules/tracking/analytics-helper/class-cartflows-pro-analytics-conversions.php';
			include_once CARTFLOWS_PRO_DIR . 'modules/tracking/analytics-helper/class-cartflows-pro-analytics-funnels.php';

			// Load analytics helper registry (provides wcf_pro_analytics() function).
			// Must be loaded after all helper classes are available.
			include_once CARTFLOWS_PRO_DIR . 'modules/tracking/class-cartflows-pro-analytics-helper-registry.php';

			// Load main analytics reports class.
...
if ( ! function_exists( 'wcf_pro' ) ) {
	 ...
	 */
	function wcf_pro() { // phpcs:ignore Universal.Files.SeparateFunctionsFromOO.Mixed
